...
import { SprayCan, ShoppingCart, Plus, Minus, Trash2, MessageCircle } from 'lucide-react'
          ...
          {productos.map((p) => (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-1 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded-lg px-3 py-2 text-xs font-medium transition active:scale-95"
              >
                <Plus size={14} />
                Agregar
              </button>
